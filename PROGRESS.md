...
### 🔜 다음 세션에서 할 것 (우선순위 순)
- [ ] **아키텍처 다이어그램** — Mermaid.js (CDN)로 프로젝트별 시스템 구성도 삽입
  - 대상: 병원 앱, 3BB IPTV, MAI-WACS 3개
  - 방식: Mermaid.js CDN + v3 카드 내 diagram 영역 추가
  - 추가 인터랙션 고려: 카드 hover 시 아키텍처 펼쳐지는 효과
- [ ] **Cloudflare Pages 배포** — GitHub 연동 자동 배포
- [ ] **커스텀 도메인 연결**
- [ ] **모바일 반응형 점검** (v3 기준)
